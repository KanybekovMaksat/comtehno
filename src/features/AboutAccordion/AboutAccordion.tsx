...
export const AboutAccordion: FC = () => {
  ...
  return (
    <div className="mb-[150px] container w-[1440px]">
      <Typography className="mb-4 text-[#18181B] font-light text-5xl">
        От знаний к делу
      </Typography>
          ...
          <Box className="flex flex-col gap-2">
            {items.map((item, index) => (
              <div key={index}>
                <button
                  className={clsx(
                    "text-left font-light transition-colors w-full p-2 text-4xl",
                    selected === index
                ...
                >
                  <div className="h-36 p-4  rounded-md shadow-sm scrollbar-thin ">
                    <Typography className="text-[#18181B] text-2xl font-light">
                      {item.content}
                    </Typography>
                  </div>
                </div>
