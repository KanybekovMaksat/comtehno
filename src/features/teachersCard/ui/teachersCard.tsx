...
const TeacherCard: React.FC<TeacherCardProps> = ({
  ...
  return (
    <div>
      <animated.div
        className={`card ${active ? "flip" : ""} 
          rounded-xl flex flex-col items-center justify-center mt-5
          r-sm:h-[320px] r-sm:w-[220px]
          r-lg:h-[320px] r-lg:w-[220px]
          h-[380px] w-[280px]
          h-[400px] w-[300px]`}
        style={propsCard}
        onClick={onClick}
      ...
      >
        <div
          ...
          style={{
            ...
            transform: isHovered && active ? "rotateY(180deg)" : "none",
          }}
        >
          <div 
            className="card-front top-0 bottom-0 left-0 right-0 absolute"
          ...
          >
            ...
            {active && (
              <div className="w-[50px] h-[50px] absolute z-10 bottom-[-25px] left-1/2 transform -translate-x-1/2">
                <img
                  src="../../../../src/shared/assets/img/category.svg"
                  alt="Bottom Image"
                />
              </div>
            )}
          ...
          <div
            className="card-back top-0 bottom-0 left-0 right-0 absolute rounded-xl text-center flex flex-col items-center bg-[#F4F4F5] r-sm:p-2 r-lg:p-2 p-5"
            style={{ transform: "rotateY(180deg)", backfaceVisibility: "hidden" }}
          >
            <h1 className="r-sm:text-sm r-sm:mt-2 r-lg:text-base text-xl font-medium">
              Oбо мне
            </h1>
            <p className="teachers__card-text r-sm:text-xs r-lg:text-xs text-sm mt-1">
              {aboutMe}
            </p>
            {active && (
              <div className="w-[50px] h-[50px] absolute z-10 bottom-[-25px] left-1/2 transform -translate-x-1/2">
...
export const TeachersCard = ({ goToSlide, setGoToSlide }: TeachersCardProps) => {
  const cardsData = [
    ...
    },
    {
      ...
      jobTitle: "Ментор по....",
      aboutMe:
        "Я преподаю программирование в колледже КОМТЕХНО и работаю преподавателем Front-End уже 2 года. Lorem ipsum, dolor sit amet consectetur adipisicing elit",
      achievements: [
        "Окончил Бишкекский колледж с дипломом с отличием",
        "Получил сертификат за участие в хакатоне Startup Nation",
    ...
    },
    {
      ...
      jobTitle: "Ментор по...",
      aboutMe:
        "Я преподаю программирование в колледже КОМТЕХНО и работаю преподавателем Lorem ipsum, dolor sit amet consectetur adipisicing elit. Lorem ipsum, dolor sit amet consectetur adipisicing elit",
      achievements: [
        "Окончил Бишкекский колледж с дипломом с отличием",
        "Lorem ipsum, dolor sit amet consectetur adipisicing elit",
        "Стал финалистом хакатона Digital Technologies",
