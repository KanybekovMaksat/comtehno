export const Internship: React.FC = () => {
  return (
    ...
    <div className='sm:bg-red-500 sm:w-[349px] w-[100%] p-[16px] rounded-[16px] bg-[#F4F4F5]'>
...
export const TimeStudy: React.FC = () => {
  return (
      <div className='sm:w-[457px] w-[100%] p-[16px] rounded-[16px] bg-[#F4F4F5]'>
          <h2 className='mb-[24px] text-[22px] sm:text-[28px] font-[400] leading-[27.5px] sm:leading-[35px] text-[#18181B]'>Срок обучения</h2>
