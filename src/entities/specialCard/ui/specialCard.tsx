...
export const SpecialCard: React.FC<SpecialCardProps> = (props) => {
  const { icon, title, name, description, key } = props

  return <Card className="hover:scale-105 hover:bg-[#f5f5f5] transition-all cursor-pointer p-4 w-[450px] max-h-64 rounded-2xl" key={key}>
