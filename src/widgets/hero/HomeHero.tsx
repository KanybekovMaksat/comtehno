      ...
      <Container className="max-w-[1440px]">
        <div className="mb-10 max-w-4xl">
          ...
          <div className="flex flex-wrap gap-3 max-w-5xl">
            <span className="border hover:bg-black hover:text-white transition-all cursor-pointer px-4 py-2 rounded-full bg-white text-black">
              Ранний старт в IT
            </span>
            <span className="border hover:bg-white hover:text-black transition-all cursor-pointer px-4 py-2 rounded-full bg-black text-white">
