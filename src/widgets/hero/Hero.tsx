...
export function Hero() {
  return (
    <section
      className="bg-cover pt-[30px] px-4 md:px-8 lg:px-16"
      style={{
    ...
    >
      <Container className="max-w-[1440px] mb-[150px]">
        <div>
          <Typography variant="h3" className="text-white font-geologica sm:text-[120px] text-[50px] font-[600] text-center">
