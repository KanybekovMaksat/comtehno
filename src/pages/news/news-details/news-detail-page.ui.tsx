...
export const NewsDetailPage = () => {
  ...
  return (
    <Box
      className="relative w-full container pb-20 r-lg:mt-5 r-md:container
    pt-10 px-6"
    >
      <BackButton />
      <Box className="grid grid-cols-[1fr_464px] r-xl:grid-cols-[1fr] gap-[30px]">
        <Box>
          ...
          <Box
            ...
            className="r-xl:w-full rounded-xl"
          />
